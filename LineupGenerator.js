...
const generateLineup = (array1, array2, array3) => {
    ...
    let lineUp = `First up, we have ${array3[opener]} opening the night! Followed by the support act, ${array2[supporter]}! Finally, headlining the show is ${array1[headliner]}!`;
    return lineUp;
}
